...
AddEventHandler('rw-rental:client:rent', function(data)
    ...
    QBCore.Functions.SpawnVehicle(vehicle, function(veh)
        SetVehicleNumberPlateText(veh, "HURTZ"..tostring(math.random(1000, 9999)))
...
CreateThread(function()
    exports['qb-target']:AddTargetModel(`a_f_m_bevhills_01`, {
        options = {
        {
            type = "client",
...
Citizen.CreateThread(function()
    ...
    for i=1, #Config.PedSpawn do
      local pedModel = "a_f_m_bevhills_01"
      local pedName = "Beverly"
...
AddEventHandler('rw-rental:client:deliverVehicle', function()
    QBCore.Functions.Notify('Your vehicle has been returned!', 'success', 2000)
...
Citizen.CreateThread(function()
	...
	AddTextComponentSubstringPlayerName("Hurtz Car Rental") 
